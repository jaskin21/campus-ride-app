...
export class ApiStack extends cdk.Stack {
  constructor( scope: Construct, id: string, props: ApiStackProps ) {
    ...
    const updateDestinationFn = new NodejsFunction( this, 'UpdateDestinationFn', {
      ...lambdaDefaults,
      entry: path.join( __dirname, '../lambdas/queue/updateDestination.ts' ),
      handler: 'handler',
    } )

    const offboardPassengerFn = new NodejsFunction( this, 'OffboardPassengerFn', {
      ...lambdaDefaults,
      entry: path.join( __dirname, '../lambdas/queue/offboardPassenger.ts' ),
      handler: 'handler',
    } )
    ...
    table.grantReadWriteData( updateDestinationFn )
    table.grantReadWriteData( offboardPassengerFn )
    ...
    queueResource.addResource( 'destination' ).addMethod(
      'PUT',
      new apigw.LambdaIntegration( updateDestinationFn ),
